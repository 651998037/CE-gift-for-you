...
controller.show=(req,res) => {
    req.getConnection((err, conn) => {
        conn.query('SELECT deliveryperson.id,deliveryperson.prepare,n.name as name,n.phone as phone,n.lineid as lineid,n.gender as gender FROM deliveryperson join person as n on deliveryperson.person=n.id',(err, deliveryperson) => {
            if (err) {
                res.json(err);
            }
            res.render('./admin/deliverypersonView/deliverypersonList',{
    ...
    req.getConnection((err, conn) => {
        ...
        conn.query('SELECT id, donationplace, travel FROM prepare', (err, prepare) => {
            conn.query('SELECT id, name FROM person', (err, person) => {
                    res.render('./admin/deliverypersonView/deliverypersonAdd',{
        ...
        req.getConnection((err, conn) => {
            ...
            conn.query('SELECT * FROM prepare', (err, prepare) => {
                conn.query('SELECT * FROM person', (err, person) => {
                        ...
                        res.render('./admin/deliverypersonView/deliverypersonEdit',{
...
controller.delete=(req, res) => {
    ...
    res.render('./user/deliverypersonView/confirmDel',{
