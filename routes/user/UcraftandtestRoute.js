...
const UcraftandtestController=require('../../controllers/user/UcraftandtestController/UcraftandtestController');
const validator = require('../../controllers/user/UcraftandtestController/UcraftandtestValidator');
...
router.post('/Ucraftandtest/save/:id', validator.Ucraftandtest, UcraftandtestController.save);
